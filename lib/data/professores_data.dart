...
List<ProfessorModel> criarProfessores() {
  return [
    ...
    ProfessorModel(id: 'prof_fabiane', nome: 'Fabiane Sobar'),
    ...
    ProfessorModel(id: 'prof_vander', nome: 'Vander'),
    // UX/UI & Sites Dinâmicos (JavaScript)
    ProfessorModel(id: 'prof_guilherme', nome: 'Guilherme'),
    // POO & UML (Java)
    ...
    ProfessorModel(id: 'prof_andre', nome: 'Andre'),
    ...
    ProfessorModel(id: 'prof_verspegel', nome: 'Jefferson Verspegel'),
  ];
}
